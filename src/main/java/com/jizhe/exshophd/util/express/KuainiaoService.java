...
public class KuainiaoService {
    //id、key、url
    private final String EBusinessID="1713446";
    private final String ApiKey="20ed13f0-0ea5-42d2-b782-9ae1b570356e";
    ...
    public static void main(String[] args) {
        try {
            KuainiaoService api = new KuainiaoService();
            String res = api.orderOnlineByJson("STO","773096380913475");
            JSONObject jsonObject = JSONObject.parseObject(res);
            String xxx = jsonObject.getString("Success");
